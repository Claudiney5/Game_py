...
class Game(tk.Tk):
    ...
    def show_next_screen(self):
        ...
        if self.current_screen_number < len(self.game_screens):
            ...
            self.screen.create_text((250, 300), text="Você venceu!!", font=self.sucess_font, fill="white")
...
if __name__ == "__main__":
    ...
    scene1 = GameScreen(game, "assets/scene1.png", (378, 135, 427, 217), "key", "Você tem que sair, "
